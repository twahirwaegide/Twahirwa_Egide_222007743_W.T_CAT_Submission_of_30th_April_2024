...
if ($result->num_rows > 0) {
    ...
    echo "<th style='border: 1px solid #ccc; padding: 8px;'>Product Name</th>";
    echo "<th style='border: 1px solid #ccc; padding: 8px;'>Product Type</th>";
    echo "<th style='border: 1px solid #ccc; padding: 8px;'>Price</th>";
    echo "<th style='border: 1px solid #ccc; padding: 8px;'>Quantity</th>";
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        echo "<td style='border: 1px solid #ccc; padding: 8px;'>" . $row['productName'] . "</td>";
        echo "<td style='border: 1px solid #ccc; padding: 8px;'>" . $row['productType'] . "</td>";
        echo "<td style='border: 1px solid #ccc; padding: 8px;'>" . $row['price'] . "</td>";
        echo "<td style='border: 1px solid #ccc; padding: 8px;'>" . $row['quantity'] . "</td>";
