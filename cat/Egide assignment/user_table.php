...
if ($result->num_rows > 0) {
    ...
    echo "<th style='border: 1px solid #ccc; padding: 8px;'>password</th>";
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        echo "<td style='border: 1px solid #ccc; padding: 8px;'>" . $row['username'] . "</td>";
        echo "<td style='border: 1px solid #ccc; padding: 8px;'>" . $row['role'] . "</td>";
        echo "<td style='border: 1px solid #ccc; padding: 8px;'>" . $row['password'] . "</td>";
